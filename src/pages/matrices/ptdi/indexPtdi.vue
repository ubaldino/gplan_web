<template>
  ...
  <a-tabs v-model:activeKey="activeKey" type="card" class="padding">
    <a-tab-pane key="1" tab="1. DATOS GENERALES DEL SECTOR DE PLANIFICACIÓN">
      ...
      >
        <a-form-item
          :name="['formtab1ptdi', 'nombresectorptdi']"
        ...
        <a-form-item
          :name="['formtab1ptdi', 'lineamientoestrategicoptdi']"
          label="LINEAMIENTO ESTRATÉGICO DE TERRITORIO"
        >
          <a-textarea
            style="width: sm"
            v-model:value="formState.formtab1ptdi.lineamientoestrategicoptdi"
          />
        </a-form-item>
        <a-form-item
          :name="['formtab1ptdi', 'objetivoestrategicoptdi']"
          label="OBJETIVO ESTRATÉGICO"
        >
          <a-textarea
            style="width: sm"
            v-model:value="formState.formtab1ptdi.objetivoestrategicoptdi"
          />
        </a-form-item>
    ...
    <a-tab-pane key="4" tab="4. REGISTRO RESULTADO">
      ...
      >
        <a-form-item
          :name="['formtab4datoresultado', 'entidad']"
          label="ENTIDAD"
        >
          <a-select
        ...
        <a-form-item
          :name="['formtab4datoresultado', 'areasorganizacionales']"
          label="ÁREAS ORGANIZACIONALES"
        >
          <a-tree-select
            v-model:value2="
              formState.formtab4datoresultado.areasorganizacionales
            "
            style="width: sm"
            :tree-data="treeData3"
            tree-checkable
        ...
        <a-form-item
          :name="['formtab4datoresultado', 'codigoresultado']"
          label="CÓDIGO DEL RESULTADO"
        >
          <a-input
            v-model:value="formState.formtab4datoresultado.codigoresultado"
          />
        </a-form-item>
        <a-form-item
          :name="['formtab4datoresultado', 'descripcion']"
          label="DESCRIPCIÓN"
        >
          <a-select
        ...
        <a-form-item
          :name="['formtab4datoresultado', 'agregarnuevadescripcion']"
        ...
        >
          <div align="center">
            ...
            >
              <a-form-item
                :name="['formtab4datoresultado', 'detalle']"
                label="DETALLE"
              >
                <a-textarea
                  v-model:value="formState.formtab4datoresultado.detalle"
                />
              </a-form-item>
            </a-modal>
          </div>
      ...
      >
        <a-row>
          <a-col :span="24">
            <a-form-item
              align="center"
              :name="['formtab5datosindicadorresultado', 'encendidoindicardor']"
              label="INDICADOR ABSOLUTO (ENCENDIDO) / INDICADOR RELATIVO (APAGADO)"
            >
            ...
            <div v-if="!checked">
              ...
              >
                <a-select
                  v-model:value="
                    formState.formtab5datosindicadorresultado
                      .tipoindicadorabsoluto
                  "
                  show-search
              ...
              <a-form-item
                :name="['formtab5datosindicadorresultado', 'formulaabsoluto']"
                label="FÓRMULA INDICADOR ABSOLUTO"
              >
                <a-input
                  v-model:value="
                    formState.formtab5datosindicadorresultado.formulaabsoluto
                  "
                />
              </a-form-item>
            </div>
            <div v-else-if="checked">
              ...
              <a-form-item
                :name="['formtab5datosindicadorresultado', 'formularelativo']"
                label="FÓRMULA INDICADOR RELATIVO"
              >
                <a-input
                  v-model:value="
                    formState.formtab5datosindicadorresultado.formularelativo
                  "
                />
              </a-form-item>
              <a-form-item
                :name="[
                  'formtab5datosindicadorresultado',
                  'encendidodenominador',
                ]"
                label="DENOMINADOR VARIABLE (ENCENDIDO) / DENOMINADOR FIJO (APAGADO)"
              >
        ...
        <a-form-item :wrapper-col="{ ...layout.wrapperCol, offset: 8 }">
          <a-button type="primary" html-type="submit"
            >GUARDAR INDICADOR RESULTADO</a-button
          >
        </a-form-item>
      </a-form>
    </a-tab-pane>
    ...
    <a-tab-pane key="6" tab="6. PROGRAMACIÓN FÍSICA">
      ...
      >
        <a-form-item
          :name="['formtab6programacionfisica', 'lineabase2020']"
          label="LINEA BASE 2020"
          :rules="[{ type: 'number', min: 0, max: 100 }]"
        >
          <a-input-number
            v-model:value="formState.formtab6programacionfisica.lineabase2020"
          />
        </a-form-item>
        <a-form-item
          :name="['formtab6programacionfisica', 'meta2025']"
          label="META AL 2025"
          :rules="[{ type: 'number', min: 0, max: 100 }]"
        >
          <a-input-number
            v-model:value="formState.formtab6programacionfisica.meta2025"
          />
        </a-form-item>
        <a-divider style="border-color: #8db600" dashed />
        <div align="center">
          <a-row>
            <a-col :xs="20" :sm="16" :md="12" :lg="8" :xl="4">
              <a-row>
                <a-col :md="24"> 2021 </a-col>
                <a-col :md="24">
                  <a-form-item
                    align="center"
                    :name="['formtab6programacionfisica', 'linea2021']"
                    :rules="[{ type: 'number', min: 0, max: 100 }]"
                  >
                    <a-input-number
                      v-model:value="
                        formState.formtab6programacionfisica.linea2021
                      "
                    />
                  </a-form-item>
                </a-col>
            ...
            <a-col :xs="20" :sm="16" :md="12" :lg="8" :xl="4">
              <a-row>
                <a-col :md="24"> 2022 </a-col>
                <a-col :md="24">
                  <a-form-item
                    align="center"
                    :name="['formtab6programacionfisica', 'linea2022']"
                    :rules="[{ type: 'number', min: 0, max: 100 }]"
                  >
                    <a-input-number
                      v-model:value="
                        formState.formtab6programacionfisica.linea2022
                      "
                    />
                  </a-form-item>
                </a-col>
            ...
            <a-col :xs="20" :sm="16" :md="12" :lg="8" :xl="4">
              <a-row>
                <a-col :md="24"> 2023 </a-col>
                <a-col :md="24">
                  <a-form-item
                    align="center"
                    :name="['formtab6programacionfisica', 'linea2023']"
                    :rules="[{ type: 'number', min: 0, max: 100 }]"
                  >
                    <a-input-number
                      v-model:value="
                        formState.formtab6programacionfisica.linea2023
                      "
                    />
                  </a-form-item>
                </a-col>
            ...
            <a-col :xs="20" :sm="16" :md="12" :lg="8" :xl="4">
              <a-row>
                <a-col :md="24"> 2024 </a-col>
                <a-col :md="24">
                  <a-form-item
                    align="center"
                    :name="['formtab6programacionfisica', 'linea2024']"
                    :rules="[{ type: 'number', min: 0, max: 100 }]"
                  >
                    <a-input-number
                      v-model:value="
                        formState.formtab6programacionfisica.linea2024
                      "
                    />
                  </a-form-item>
                </a-col>
            ...
            <a-col :xs="20" :sm="16" :md="12" :lg="8" :xl="4">
              <a-row>
                <a-col :md="24"> 2025 </a-col>
                <a-col :md="24">
                  <a-form-item
                    align="center"
                    :name="['formtab6programacionfisica', 'linea2025']"
                    :rules="[{ type: 'number', min: 0, max: 100 }]"
                  >
                    <a-input-number
                      v-model:value="
                        formState.formtab6programacionfisica.linea2025
                      "
                    />
                  </a-form-item>
                </a-col>
        ...
        <a-divider style="border-color: #8db600" dashed />
        <a-form-item
          :name="['formtab6programacionfisica', 'ponderacionprioridad']"
          label="PONDERACIÓN PRIORIDAD"
          :rules="[{ type: 'number', min: 0, max: 100 }]"
        >
          <a-input-number
            v-model:value="
              formState.formtab6programacionfisica.ponderacionprioridad
            "
          />
        </a-form-item>
        <a-form-item
        ...
        >
          <a-textarea
            v-model:value="
              formState.formtab6programacionfisica.fuenteinformacionverificacion
            "
          />
        </a-form-item>
        <a-form-item :wrapper-col="{ ...layout.wrapperCol, offset: 8 }">
          <a-button type="primary" html-type="submit"
            >GUARDAR PROGRAMACIÓN FÍSICA</a-button
          >
        </a-form-item>
      </a-form>
    </a-tab-pane>
    ...
    <a-tab-pane key="8" tab="8. PROGRAMACIÓN FINANCIERA"
...
const data = [
  ...
  },
  {
    ...
    resultado:
      "SE HA CONTINUADO DE MANERA SOBERANA CON LA IMPLEMENTACIÓN DE MEDIDAS QUE PERMITEN DEVOLVER AL PAÍS LA SOSTENIBILIDAD MACROECONÓMICA Y EL CRECIMIENTO.",
    accion:
      "Establecer medidas para retomar la senda de crecimiento económico.",
