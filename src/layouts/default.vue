  ...
  <q-layout view="hhh lpR fff">
    <q-header reveal elevated class="bg-primary text-white" height-hint="98">
      ...
      <q-tabs align="left">
        ...
        <q-route-tab to="/ptdi" label="Ptdi" />
        <q-route-tab to="/pdes" label="Pdes" />
        <q-route-tab to="/pilares" label="Pilares" />
        <q-route-tab to="/ejes" label="Ejes" />
      </q-tabs>
    </q-header>

    <q-drawer show-if-above v-model="leftDrawerOpen" side="left" elevated>
      <q-list>
        <q-expansion-item icon="pages" label="Sector Planificacion">
          <q-list class="q-pl-lg">
            <q-item
              to="/sector/planificacion/tecnico"
            ...
            >
              ...
              <q-item-section>
                <q-item-label>Técnico Unidad Institucional</q-item-label>
              </q-item-section>
            </q-item>
